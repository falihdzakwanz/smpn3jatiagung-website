...
const Toaster: React.FC<ToasterProps> = ({
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-4 px-8 text-lg">
                <span>
                    {type === 'success' ? (
                        <FaCheck size={24} />
                    ) : (
            ...
            <div
                className={`mt-4 h-1 w-full rounded ${type === 'success' ? 'bg-color-succes' : 'bg-color-danger'} overflow-hidden`}
            >
                <div
